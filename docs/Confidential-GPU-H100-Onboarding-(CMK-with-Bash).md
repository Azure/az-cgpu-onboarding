...
- Download [cgpu-h100-auto-onboarding-linux.tar.gz](https://github.com/Azure/az-cgpu-onboarding/releases/download/V3.2.4/cgpu-h100-auto-onboarding-linux.tar.gz) from [az-cgpu-onboarding-V3.2.4](https://github.com/Azure/az-cgpu-onboarding/releases/tag/V3.2.4)
-------------------------------------------
...
- Decompress downloaded [cgpu-h100-auto-onboarding-linux.tar.gz](https://github.com/Azure/az-cgpu-onboarding/releases/download/V3.2.4/cgpu-h100-auto-onboarding-linux.tar.gz) and enter the folder through your bash window.
```
