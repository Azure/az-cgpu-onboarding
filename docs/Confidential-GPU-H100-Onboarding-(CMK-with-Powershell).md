...
- Download [cgpu-h100-auto-onboarding-windows.zip](https://github.com/Azure/az-cgpu-onboarding/releases/download/V4.1.7/cgpu-h100-auto-onboarding-windows.zip) from [az-cgpu-onboarding-V4.1.7](https://github.com/Azure/az-cgpu-onboarding/releases/tag/V4.1.7)
...
- Decompress downloaded [cgpu-h100-auto-onboarding-windows.zip](https://github.com/Azure/az-cgpu-onboarding/releases/download/V4.1.7/cgpu-h100-auto-onboarding-windows.zip) and enter the folder through powershell.
```
