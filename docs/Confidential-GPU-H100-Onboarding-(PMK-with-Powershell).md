...
- Download [cgpu-h100-auto-onboarding-windows.zip](https://github.com/Azure/az-cgpu-onboarding/releases/download/V4.3.2/cgpu-h100-auto-onboarding-windows.zip) from [az-cgpu-onboarding-V4.3.2](https://github.com/Azure/az-cgpu-onboarding/releases/tag/V4.3.2)
...
- Decompress downloaded [cgpu-h100-auto-onboarding-windows.zip](https://github.com/Azure/az-cgpu-onboarding/releases/download/V4.3.2/cgpu-h100-auto-onboarding-windows.zip) and enter the folder through powershell.
```
...
# enablesnapshot <timestamp>: enable Ubuntu snapshot with a specified timestamp (default: 20260315T120000Z; set to 0 to disable)
