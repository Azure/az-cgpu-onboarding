...
| `--ocsp_url OCSP_SERVICE_URL`                                                   | The URL to be used for checking the revocation status of a certificate (e.g., `https://useast2.thim.azure.net/nvidia/ocsp/`)                                                                                                                                                                                 |
| `--ocsp_nonce_enabled` | Flag which indicates whether to include a nonce when calling OCSP. Only applicable for local GPU attestation. False by default |
